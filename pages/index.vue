...
import axios from 'axios'
  export default {
    ...
    methods:{
      async getMovies(){
        const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=2f1acb76b010df3f1985a605ffa88fd0&language=en-US&page=1')
      ...
      async searchMovies(){
        const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=2f1acb76b010df3f1985a605ffa88fd0&language=en-US&page=1&query=${this.searchInput}`)
        const result = await data
        result.data.results.forEach((movie) => {
